...
/// State management for Groups using ChangeNotifier
/// This replaces the BLoC-based approach to match the project's Provider pattern
class GroupsProvider extends ChangeNotifier {
  ...
  bool _isTransferringAdmin = false;
  ...
  bool get isTransferringAdmin => _isTransferringAdmin;
  ...
  Future<bool> transferAdminRole({
    ...
    try {
      ...
      _setTransferringAdmin(false);
    }
  }

  /// Leave group
  Future<bool> leaveGroup(String groupId) async {
    _setLeavingGroup(true);
    _clearError();
  ...
  void _setAddingMember(bool adding) {
    _isAddingMember = adding;
    notifyListeners();
  }

  void _setRemovingMember(bool removing) {
    _isRemovingMember = removing;
    notifyListeners();
  }

  void _setTransferringAdmin(bool transferring) {
    _isTransferringAdmin = transferring;
    notifyListeners();
  }

  void _setLeavingGroup(bool leaving) {
    _isLeavingGroup = leaving;
    notifyListeners();
  }
