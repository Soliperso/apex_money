...
enum AvatarStyle { standard, gradient, premium, minimal }

enum StatusIndicator { none, online, offline, verified, premium }
...
class AvatarUtils {
  ...
  static List<Color> getGradientColors(String name, BuildContext context) {
    ...
    final gradients = [
      ...
      [
        colorScheme.success,
        colorScheme.success.withValues(alpha: 0.8),
      ], // Success gradient
      [
        colorScheme.warning,
      ...
      [
        colorScheme.info,
        colorScheme.info.withValues(alpha: 0.8),
      ], // Info gradient
      [
        colorScheme.primaryContainer,
        colorScheme.primary,
      ], // Primary container gradient
      [
        colorScheme.secondaryContainer,
        colorScheme.secondary,
      ], // Secondary container gradient
      [
  ...
  static Widget _buildStandardAvatar(
    ...
    return Container(
      ...
      child: CircleAvatar(
        ...
        backgroundColor:
            profilePicture == null
                ? getAvatarColor(userName, context)
                : Colors.transparent,
        child:
            profilePicture == null
                ? Text(
  ...
  static Widget _buildPremiumAvatar(
    BuildContext context,
    String userName,
    String? profilePicture,
    double radius,
  ...
  static Widget _buildMinimalAvatar(
    ...
    return CircleAvatar(
      ...
      backgroundColor:
          profilePicture == null
              ? getAvatarColor(userName, context).withValues(alpha: 0.1)
              : Colors.transparent,
      child:
          profilePicture == null
              ? Text(
  ...
  static Widget _buildStatusIndicator(
    ...
    return Container(
      ...
      child:
          icon != null
              ? Icon(icon, size: size * 0.6, color: colorScheme.onPrimary)
              : null,
    );
  }
